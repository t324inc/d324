      ...
      foreach ($extraFeatures as $extra_feature_key => $extra_feature_info) {
        ...
        if (isset($extra_feature_info['config_form']) &&
          ...
          if (isset($extra_feature_info['formbit'])) {
            $formbit_file_name = drupal_get_path('profile', 'd324') . '/' . $extra_feature_info['formbit'];
      ...
      foreach ($demoContent as $demo_content_key => $demo_content_info) {
        ...
        if (isset($demo_content_info['config_form']) &&
          ...
          if (isset($demo_content_info['formbit'])) {
            $formbit_file_name = drupal_get_path('profile', 'd324') . '/' . $demo_content_info['formbit'];
            if (file_exists($formbit_file_name)) {
      ...
      foreach ($extraFeatures as $extra_feature_key => $extra_feature_info) {
        ...
        if (isset($extra_feature_info['config_form']) &&
          ...
          if (file_exists($formbit_file_name)) {
            ...
            $GLOBALS['install_state']['d324']['extra_features_configs'] = $extra_features_editable_configs;
          }
        }
      }

      $GLOBALS['install_state']['d324']['extra_features_values'] = $extra_features_values;
    }
      ...
      foreach ($demoContent as $demo_content_key => $demo_content_info) {
        ...
        if (isset($demo_content_info['config_form']) &&
          ...
          if (file_exists($formbit_file_name)) {
            ...
            $GLOBALS['install_state']['d324']['demo_content_configs'] = $demo_content_editable_configs;
          }
        }
      }

      $GLOBALS['install_state']['d324']['demo_content_values'] = $demo_content_values;
    }
  }
