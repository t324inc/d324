...
/**
 * @file
 * FormBit file for d324_development feature mdoule.
 */
 ...
 */
function d324_development_get_editable_config_names() {
  $editable_cofnigs = [
    'system.logging' => [
 ...
 *   Install state.
 */
function d324_development_build_formbit(array &$formbit, FormStateInterface &$form_state, array &$install_state = NULL) {
  $formbit['error_level'] = [
    '#type' => 'radios',
 ...
 */
function d324_development_submit_formbit(array $editable_config_values) {
